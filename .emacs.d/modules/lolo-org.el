 ...
 ((:title
  ...
  ("Basic" (("a" (hot-expand "<a") "ascii")
   ...
   (("u" (hot-expand "<s" "plantuml :file CHANGE.png") "plantuml")
    ("Y"
     (hot-expand "<s" "ipython :session :exports both :results raw drawer\n$0")
     "ipython")
    ("P" (progn
       (insert
...
prepended to the element after the #+HEADER: tag."
 ...
 (use-package org-rich-yank :bind (:map org-mode-map ("C-M-y" . org-rich-yank)))
 ...
 (use-package org-fragtog :diminish :hook (org-mode . org-fragtog-mode))
