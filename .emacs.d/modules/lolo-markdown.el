...
"
 ...
 (with-no-warnings
   ...
   (defun my-markdown-export-and-preview (fn)
     ...
     (if (featurep 'xwidget-internal)
         (lolo-webkit-browse-url (concat "file://" (markdown-export)) t)
       (funcall fn)))
   (advice-add
    #'markdown-export-and-preview
    :around #'my-markdown-export-and-preview))
 ...
 (use-package
  markdown-toc
  :diminish
  :bind (:map markdown-mode-command-map ("r" . markdown-toc-generate-or-refresh-toc))
