;;; lolo-bookmark.el --- Zrik's Emacs setup.  -*- lexical-binding: t; -*-
;;
;;; Commentary:
;;
;;
                ...
                (type
                 (let ((fmt "%-8.8s"))
                   (cond
                    ...
                    (t
                     (propertize (format fmt "FILE") 'face 'success)))))
                (icon
...
(provide 'lolo-bookmark)
;;; lolo-bookmark.el ends here
