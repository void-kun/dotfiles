...
(use-package
 ...
 :config (add-hook 'emacs-lisp-mode-hook (lambda () (smartparens-mode -1))))
...
(use-package package-lint :defer t :straight (:build t))

(use-package
 eask-api
 :defer t
 :straight (eask-api :type git :host github :repo "emacs-eask/eask-api"))

(use-package
 eask-mode
 :defer t
 :straight (eask-mode :type git :host github :repo "emacs-eask/eask-mode"))

;; ============================================================================
(use-package elisp-autofmt :defer t :straight (:build t))
