;;; lolo-player.el --- Zrik's Emacs setup.  -*- lexical-binding: t; -*-
;;
;;; Commentary:
;;
;;
...
(when lolo-player
       ...
       (defun bongo-add-dired-files ()
         ...
         (let (file
           ...
           (dired-map-over-marks
            ...
            nil t)
           (with-bongo-library-buffer (mapc 'bongo-insert-file files)))
  ...
  ;; MPD Interface
  (use-package mingus :bind ("M-<f8>" . mingus))
  ...
  (when (executable-find "mpc")
    (use-package
     ...
     (simple-mpc-main-name
      ((t (:inherit font-lock-string-face :bold t :height 1.3))))
     (simple-mpc-main-headers
      ((t (:inherit font-lock-keyword-face :bold t :height 1.1))))
