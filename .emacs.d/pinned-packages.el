;;; init-pinned-packages.el --- Zrik's Emacs setup.  -*- lexical-binding: t; -*-
;;
;;; Commentary:
;;
;;
...
(setq package-pinned-packages
      '(
        ...
        (gruber-darker-theme . "melpa-stable")
        (zop-to-char . "melpa-stable")
        ))

(provide 'init-pinned-packages)
;;; init-pinned-packages.el ends here
