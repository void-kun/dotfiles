...
;;; lolo-org.el --- xxx.	-*- lexical-binding: t -*-
...
(use-package org
  ...
  :hook (((org-babel-after-execute org-mode) . org-redisplay-inline-images) ; display image
         (org-mode . (lambda ()
                       ...
                       (when lolo-prettify-org-symbols-alist
                         (if prettify-symbols-alist
                             (push lolo-prettify-org-symbols-alist prettify-symbols-alist)
                           (setq prettify-symbols-alist lolo-prettify-org-symbols-alist)))
...
prepended to the element after the #+HEADER: tag."
  ...
  (when (featurep 'xwidget-internal)
    (push '("\\.\\(x?html?\\|pdf\\)\\'"
            .
            (lambda (file _link)
              (lolo-webkit-browse-url (concat "file://" file) t)))
          org-file-apps))
...
(use-package org-roam
  ...
  :init
  (setq org-roam-directory (file-truename lolo-org-directory)
