...
;;; lolo-custom.el --- xxx.	-*- lexical-binding: t -*-
...
(defcustom lolo-full-name user-full-name
    "Set user full name."
    :group 'lolo
    :type 'string)
...
(defcustom lolo-theme 'default
    "The color theme."
    :group 'lolo
    :type `(choice lolo-theme-alist))
...
(defcustom lolo-chinese-calendar nil
    "Enable Chinese calendar or not."
    :group 'lolo
    :type 'boolean)

(defcustom lolo-player nil
...
(defcustom lolo-prettify-org-symbols-alist
    '(("[ ]"            . ?)
      ("[-]"            . ?)
      ("[X]"            . ?)
      (":PROPERTIES:"   . ?)
